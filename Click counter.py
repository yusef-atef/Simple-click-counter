...
click = canvas.create_oval(100, 5, 205, 110, fill="green")
reset = canvas.create_oval(215, 55, 275, 115, fill="red")

canvas.tag_bind(click, "<1>", on_click)
canvas.tag_bind(reset, "<1>", on_reset)

text1 = canvas.create_text(152, 58, text="Click", fill='#FF5733', font=("Helvetica", 20, "bold"))
text2 = canvas.create_text(245, 85, text="Reset", fill="black", font=("Helvetica", 10, "bold"))
